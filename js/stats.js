(function attachLaneLabStats(root) {
  ...
  function normalizeGameRecord(record, index = 0) {
    ...
    return {
      ...
      strikes: record.strikes !== null && record.strikes !== undefined && record.strikes !== '' && Number.isInteger(Number(record.strikes)) && Number(record.strikes) >= 0
        ? Math.min(12, Number(record.strikes))
        : null,
      spares: record.spares !== null && record.spares !== undefined && record.spares !== '' && Number.isInteger(Number(record.spares)) && Number(record.spares) >= 0
        ? Math.min(10, Number(record.spares))
        : null,
      spareOpportunities: record.spareOpportunities !== null && record.spareOpportunities !== undefined && record.spareOpportunities !== '' && Number.isInteger(Number(record.spareOpportunities)) && Number(record.spareOpportunities) >= 0
      ...
      metricsProvided: record.metricsProvided && typeof record.metricsProvided === 'object'
        ...
        : null,
      strikeRate: record.strikeRate !== null && record.strikeRate !== undefined && record.strikeRate !== '' ? percentage(record.strikeRate) : null,
      spareRate: record.spareRate !== null && record.spareRate !== undefined && record.spareRate !== '' ? percentage(record.spareRate) : null
    };
  }
